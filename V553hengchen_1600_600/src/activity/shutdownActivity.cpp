...
static ZKTextView* mLogoTextViewPtr;
...
void shutdownActivity::onCreate() {
	Activity::onCreate();
    mLogoTextViewPtr = (ZKTextView*)findControlByID(ID_SHUTDOWN_LogoTextView);
	mActivityPtr = this;
	onUI_init();
...
void shutdownActivity::videoLoopPlayback(ZKVideoView *pVideoView, int msg, size_t callbackTabIndex) {
