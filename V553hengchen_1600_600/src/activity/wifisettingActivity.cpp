...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_WIFISETTING_settingButton, onButtonClick_settingButton,
    ID_WIFISETTING_sys_home, onButtonClick_sys_home,
...
wifisettingActivity::~wifisettingActivity() {
    ...
    mTextView2Ptr = NULL;
    mTextView1Ptr = NULL;
    mTextMacAddrPtr = NULL;
    mTextIPAddrPtr = NULL;
    mTextview6Ptr = NULL;
    mTextview2Ptr = NULL;
    mTextview27Ptr = NULL;
    mWindowPasswordErrorPtr = NULL;
...
void wifisettingActivity::onCreate() {
	Activity::onCreate();
    mTextView3Ptr = (ZKTextView*)findControlByID(ID_WIFISETTING_TextView3);
    msys_backPtr = (ZKButton*)findControlByID(ID_WIFISETTING_sys_back);
    msettingButtonPtr = (ZKButton*)findControlByID(ID_WIFISETTING_settingButton);
    msys_homePtr = (ZKButton*)findControlByID(ID_WIFISETTING_sys_home);
