...
static ZKWindow* mincomingWindowPtr;
static ZKTextView* mtimingTextViewPtr;
static ZKTextView* mtNameTextViewPtr;
static ZKWindow* mcallWindowPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_STATUSBAR_rejectButton, onButtonClick_rejectButton,
    ID_STATUSBAR_answerButton, onButtonClick_answerButton,
};
/***************/
...
statusbar::~statusbar() {
    ...
    mincomingWindowPtr = NULL;
    mtimingTextViewPtr = NULL;
    mtNameTextViewPtr = NULL;
    mcallWindowPtr = NULL;
}
...
void statusbar::onCreate() {
    ...
    mnumberTextViewPtr = (ZKTextView*)findControlByID(ID_STATUSBAR_numberTextView);
    manswerButtonPtr = (ZKButton*)findControlByID(ID_STATUSBAR_answerButton);
    mincomingWindowPtr = (ZKWindow*)findControlByID(ID_STATUSBAR_incomingWindow);
    mtimingTextViewPtr = (ZKTextView*)findControlByID(ID_STATUSBAR_timingTextView);
    mtNameTextViewPtr = (ZKTextView*)findControlByID(ID_STATUSBAR_tNameTextView);
    mcallWindowPtr = (ZKWindow*)findControlByID(ID_STATUSBAR_callWindow);
	mstatusbarPtr = this;
	onUI_init();
    // 注册监听全局触摸
